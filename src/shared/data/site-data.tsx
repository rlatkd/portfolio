...
export const aboutIntro = [
  ...
  'CMS+를 포함한 6개 서비스를 유지보수하며 전자계약, Branch Manager 두 건의 신규 프로젝트에 참여했습니다. 2025년 10월부터는 개발과 운영을 겸해 CMS+와 Ibill의 배치 모니터링과 VoC 대응을 맡습니다.',
...
export const experience = [
  ...
  },
  {
    ...
    points: [
      ...
      '2025년 10월부터 개발과 운영 겸무 — CMS+·Ibill 배치 모니터링·VoC 대응',
      '2026년 8월부터 Ibill 오너 — 교육비 수납 플랫폼의 요구사항 구조화 및 과제 선정',
    ],
