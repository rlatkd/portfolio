...
summary: '클러스터 내의 서비스에 대한 외부 접근을 관리하는 API 오브젝트이며, 일반적으로 HTTP를 관리인그레스는 부하 분산, SSL 종료, 명칭 기반의 가상 호스팅을 제공인그레스를 사용하려면 인그레스 컨트롤러가 필요...'
image: 'https://velog.velcdn.com/images/kata/post/951ab997-a2a8-47e4-afda-bd9dd99d6381/image.png'
---
...
![](https://velog.velcdn.com/images/kata/post/8134b0cc-c7eb-499a-848b-01bb831aa0b4/image.png)
...
![](https://velog.velcdn.com/images/kata/post/f61bf595-f5b8-4ae8-b6c3-1c1e6d5c2075/image.png)
